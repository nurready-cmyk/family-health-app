...
// ---------- matchAmongList_: кнопка «Обследования» в отчёте ----------
var UZI_TYPES = ['УЗИ сердца (ЭхоКГ)', 'УЗИ щитовидной железы', 'ЭКГ'];
eq('точное совпадение', matchAmongList_(UZI_TYPES, 'узи сердца эхокг'), 'УЗИ сердца (ЭхоКГ)');
eq('название внутри более длинной фразы', matchAmongList_(UZI_TYPES, 'хочу посмотреть узи щитовидной железы у нас'), 'УЗИ щитовидной железы');
eq('ничего похожего — null', matchAmongList_(UZI_TYPES, 'общий анализ мочи'), null);
eq('короткое название тоже находится', matchAmongList_(UZI_TYPES, 'дай экг за год'), 'ЭКГ');
